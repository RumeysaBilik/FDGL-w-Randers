...
[OURS 2026-08-26, per explicit user request -- "bu high dimensional data
setine metodumuzu uygulamak istiyoruz"]
...
def main():
    ...
    ax.set_title(f"Randers-UMAP on Breast Cancer dataset (30D, StandardScaled, n={n})",
                 fontsize=10)
    fig.tight_layout()
