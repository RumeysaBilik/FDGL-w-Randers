...
Outputs
-------
    <out>_3d_field.png   ambient X coloured by t, DERIVED omega arrows
    <out>.png             embedding coloured by t, drift arrows
    <out>.npz             Y, B, t, X, omega (derived)
"""
...
def main():
    ...
    X, t = make_swiss_roll(args.n, seed=42)
    n = args.n
    ...
    # ---- 3D plot of the ambient swiss roll with the DERIVED omega field ---
    ...
    ax3d.set_title(f"Swiss roll (ambient X, n={n}) with DERIVED omega field "
