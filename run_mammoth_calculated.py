#!/usr/bin/env python3
"""
run_mammoth_calculated.py -- isumap-derived D_asym + live-derived drift, on the
mammoth point cloud. EXACT SAME pipeline as run_swiss_roll_calculated.py
(build_isumap_dist_matrix imported directly, not duplicated) -- only the
dataset changes.

See run_mammoth_generated.py's module docstring for the mammoth Randers-field
...
[OURS 2026-08-18 -- see run_swiss_roll_calculated.py's module docstring for the
